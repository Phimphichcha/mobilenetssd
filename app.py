...
lineaccesstoken = 'wtz0nqGhPodiRbTAewS6kgWmz4JI+3evtq2GCIf6vu6QnMRZTvXOuLk+1pyyREwQmOw55UlfIIrWkQV8D4DgLmueIDrTOs34GCwc7IOb5Fjl0XesQMp/3LqntakDTRKmi1ABzvpCwN90Xprs6tESNQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
             ...
             replyObj = TextSendMessage(text="ไม่เป็นไร")
             line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "เบื่อ" :
             replyObj = TextSendMessage(text="แล้วมาบอกทำไม")
             line_bot_api.reply_message(rtoken, replyObj)   
        else  :
             headers = request.headers
             json_headers = ({k:v for k, v in headers.items()})
             json_headers.update({'Host':'dialogflow.cloud.google.com'})
             url = "https://dialogflow.cloud.google.com/v1/integrations/line/fd7c0031-8d89-4cf7-be83-f0a6d580f411/webhook"
    elif msgType == "image":
        try:
